...
public class Day04_1 extends Puzzle {
    ...
    public Day04_1(String id, File inputData) {
        super(id, inputData);
    }
    ...
    public void run() {
        ...
        for (String bingoNumberString : bingoNumberStrings) {
            ...
            for (BingoBoard board : boards) {
                ...
                if (board.isComplete()) {
                    lastBingoNumberToWin = bingoNumber;
                    lastBoardToWin = board;
                }
            }
        }
        if (lastBoardToWin != null) {
            Main.LOGGER.log(Level.INFO, "{0}", lastBoardToWin.getSumOfUnmarkedNumbers() * lastBingoNumberToWin);
        }
    }
